...
@section('content')
    <section class="home-hero text-center text-white rounded-top-5 py-5"
        style="background: linear-gradient(135deg, #20c997 0%, #fd7e14 100%);">
        <div class="container">
            ...
            <form id="shorten-form" action="{{ route('home.shorten') }}" method="POST" class="row g-2 justify-content-center">
                ...
                <div class="col-md-6 position-relative">
                    <input type="url" name="original_url" class="form-control form-control-lg" id="originalUrl"
                        placeholder="{{ __('home.url_placeholder') }}" required>
                </div>
                <div class="col-md-2">
                ...
                <div class="card border-0 shadow-lg mx-auto" style="max-width: 600px;">
                    <div class="card-body text-center">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <a href="#" id="shortUrl" target="_blank"
                                class="h4 mb-0 text-success text-decoration-none"></a>
                            <button id="copyBtn" class="btn btn-outline-secondary ms-2" title="{{ __('home.copy') }}">
