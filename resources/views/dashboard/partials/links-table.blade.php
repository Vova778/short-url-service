        ...
        @foreach ($links as $link)
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('links.show', $link) }}" class="btn btn-sm align-content-center btn-info me-1"><i
                            class="fas fa-eye"></i></a>
                    <a href="{{ route('links.edit', $link) }}" class="btn btn-sm align-content-center btn-warning me-1"><i
